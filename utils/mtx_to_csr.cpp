...
int main(int argc, char** argv) {
    std::cout << "Convert a Matrix Market file to a CSR file\n";

    if (argc != 4) {
        std::cout << "Usage: " << argv[0] << " <is_symmetric> <input_matrix_market_file> <output_csr_file>\n";
        std::cout << "    <is_symmetric>: must be either True of False\n";
        std::cout << "    <input_matrix_market_file>: path to a matrix market file\n";
